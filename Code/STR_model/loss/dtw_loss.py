...
def test_loss():
    ...
    dir_path = '../../../DataSet/IAM-Online/Resized_Dataset/Train/'
    ...
    stroke_path = dir_path + f'Strokes/stroke_{img_num1}.npy'
    ...
    stroke_path = dir_path + f'Strokes/stroke_{img_num2}.npy'
    stroke = np.load(stroke_path)
