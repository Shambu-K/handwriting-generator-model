...
We test the Handwriting Transformers model on the IAM dataset. We feed the IAM dataset as input to the model with pretrained weights, and generate images in the handwriting styles of the writers in the IAM dataset, on which the model was originally trained. 
% add image
\begin{figure}[h]
  \centering
...
% \begin{figure}[h]
%   \centering
%   \includegraphics[width=0.45\textwidth]{../latex-src/Images/IAM-test3.png}
%   \caption{Example-3}
%   \label{fig:IAM-test3}
% \end{figure}
...
% \begin{figure}[h]
%   \centering
%   \includegraphics[width=0.45\textwidth]{../latex-src/Images/IAM-test4.png}
%   \caption{Example-4}
%   \label{fig:IAM-test4}
% \end{figure}
We can observe that the model is able to generate quite realistic images, capturing both global and local style patterns. The code for generating images, and more such examples, can be found \href{https://github.com/Shambu-K/handwriting-generator-model/blob/main/demo-hwt.ipynb}{here}.
