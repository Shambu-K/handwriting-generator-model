...
\subsection{Stroke Paper}
Writing order recovery is a complex problem that relates to the intrinsic properties of human handwriting. However, integrating its solution with an observed handwritten text could tell us more about a subject's characteristic handwriting than ever before. This paper proposes an innovative deterministic algorithm to recover the writing order of any thinned long static handwritten signature. Signatures have been chosen out of the belief that they are the most complex version of this problem.
...
\begin{figure}[h]
  ...
  \end{subfigure}
  \caption{\textbf{Mention Interpretation}}
  \label{fig:GAN}
\end{figure}
